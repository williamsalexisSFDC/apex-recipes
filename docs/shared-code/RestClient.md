...
**See** [AtFutureRecipes](../async-apex-recipes/AtFutureRecipes.md)

**See** [QueueableWithCalloutRecipes](../async-apex-recipes/QueueableWithCalloutRecipes.md)

**See** [ApiServiceRecipes](../integration-recipes/ApiServiceRecipes.md)

**See** [CalloutRecipes](../integration-recipes/CalloutRecipes.md)
